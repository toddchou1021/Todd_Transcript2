...
Get-Process | Where-Object { $_.ProcessName -in @("Todd Transcript", "ToddTranscriptSetup-1.0.1", "ToddTranscriptSetup-1.0.2", "ToddTranscriptSetup-1.0.3", "ToddTranscriptSetup-1.0.4", "ToddTranscriptSetup-1.0.5") } | Stop-Process -Force -ErrorAction SilentlyContinue
